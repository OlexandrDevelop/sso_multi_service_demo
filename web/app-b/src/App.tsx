...
const serviceCUrl = import.meta.env.VITE_SERVICE_C_URL || 'http://localhost:5174'
  ...
  return (
    <div style={{ padding: 24, fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ marginTop: 16, display: 'flex', gap: 12 }}>
        <a href={serviceCUrl} style={{ padding: '8px 12px', background: '#2563eb', color: '#fff', borderRadius: 6, textDecoration: 'none' }}>Go to Service C</a>
